...
// 离线裁剪版：官方插件图标不再引用 https://cdn-zcode.z.ai；listing 不带远程 icon，
// UI 侧 resolvePluginIconSource 回落到本地打包图标或默认占位图标。
const OFFICIAL_PLUGIN_ASSETS_BASE_URL = "";
function officialPluginAssetUrl(path: string): string | undefined {
  return OFFICIAL_PLUGIN_ASSETS_BASE_URL
    ? `${OFFICIAL_PLUGIN_ASSETS_BASE_URL}/${path}`
    : undefined;
}
...
export const OFFICIAL_PLUGIN_DEFINITIONS: readonly OfficialPluginDefinition[] = [
  ...
  },
  {
    listing: {
      ...
      icon: officialPluginAssetUrl("android-emulator/icon.png"),
      description_i18n: {
  ...
  },
  {
    ...
    listing: {
      ...
      icon: officialPluginAssetUrl("browser-use/icon.png"),
      description_i18n: {
  ...
  ...(
    ...
    ([name, skill, displayName, chineseName]): OfficialPluginDefinition => ({
      ...
      listing: {
        ...
        icon: officialPluginAssetUrl("document-skills/icon.png"),
  ...
  },
  {
    listing: {
      ...
      icon: officialPluginAssetUrl("ios-simulator/icon.png"),
      description_i18n: {
  ...
  },
  {
    listing: {
      ...
      icon: officialPluginAssetUrl("restore-legacy-sessions/icon.png"),
      description_i18n: {
  ...
  },
  {
    ...
    listing: {
      ...
      icon: officialPluginAssetUrl("skill-creator/icon.png"),
  ...
  },
  {
    ...
    listing: {
      ...
      icon: officialPluginAssetUrl("zcode-guide/icon.png"),
      description_i18n: {
  ...
  },
  {
    ...
    listing: {
      ...
      icon: officialPluginAssetUrl("zcode-cua/icon.png"),
    },
    rootCandidates: [
