...
const enUS: Record<string, string> = {
  ...
  "settings.remoteDevice.addHint": "Add a remote device to use its projects and sessions.",
  ...
  "settings.remoteDevice.connect": "Connect",
  "settings.remoteDevice.disconnect": "Disconnect",
  "settings.remoteDevice.status.never": "Not connected",
  ...
  "settings.modelProvider.noProvidersState":
    "No model providers available yet. Use \u201cAdd provider\u201d in the top right to configure one.",
