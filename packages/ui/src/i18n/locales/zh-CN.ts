...
const zhCN: Record<string, string> = {
  ...
  "login.description": "配置模型供应商，开始使用 ZCode",
  ...
  "settings.remoteDevice.addHint": "添加一台远程设备，连接后即可使用其项目与会话。",
  "settings.remoteDevice.field.host": "主机地址",
  "settings.remoteDevice.field.username": "用户名",
  "settings.remoteDevice.field.privateKeyPath": "密钥文件路径",
  "settings.remoteDevice.field.privateKeyPathHint": "引用系统里的密钥文件；密钥内容不会被保存。",
  "settings.remoteDevice.save": "保存设备",
  "settings.remoteDevice.edit": "编辑",
  "settings.remoteDevice.remove": "移除设备",
  "settings.remoteDevice.connect": "连接",
  "settings.remoteDevice.disconnect": "断开",
  "settings.remoteDevice.status.never": "未连接",
  ...
  "settings.modelProvider.noProvidersState":
    "还没有可用的模型供应商。点击右上角「添加供应商」自行配置。",
